...
import { ConversationTemplatesSettings } from './ConversationTemplatesSettings';
    ...
    <Tabs
      items={[
        ...
        ...(knowledgeBaseEnabled
          ...
          : []),
        {
          key: 'conversationTemplates',
          label: t('Conversation templates'),
          children: <ConversationTemplatesSettings />,
          forceRender: true,
        },
      ]}
    />
